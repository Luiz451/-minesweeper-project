package campo_minado.src.br.com.cod3r.cm.vision;

import campo_minado.src.br.com.cod3r.cm.exception.ExplosaoException;
import campo_minado.src.br.com.cod3r.cm.exception.SairDoJogoException;
    ...
    private void cicloDoJogo() {
        try {
            ...
            while(!tabuleiro.objetivoAlcancado()) {
                ...
                String digitado = capturarValorDigitado("Digite (x, y) ou sair para sair do jogo: ");
